...
/**
 * RAS用的是非对称加解密算法，无法继承IEncipherTool
 * 
 * @author tuhanbao
 *
 */
public class RSAEncipherTool {
    ...
    public static String getPrivateKey(Map<String, Key> keyMap) throws Exception {
        ...
        return Base64Util.encode(keyByte);
    }
...
//        Map<String, Key> keyMap = initKeys();
//
//        String publicKey = RSAEncipherTool.getPublicKey(keyMap);
//        String privateKey = RSAEncipherTool.getPrivateKey(keyMap);
...
//        String data1 = RSAEncipherTool.encryptByPublicKeyStr(data, publicKey);
//        System.out.println("公钥加密前:\n" + data);
//        System.out.println("公钥加密后：\n" + data1);
//
//        String data2 = RSAEncipherTool.decryptByPrivateKeyStr(data1, privateKey);
