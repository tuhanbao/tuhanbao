...
public class Excel2007Util
{
     ...
     * @param index 从0开始
     * @param result
     * @param append 是否对在原有的基础上增写，如果append = false，将清除掉原有的所有数据
     * @throws Exception
     */
     ...
     * @param url
     * @param index
     * @param formulasNotResults 是否自动计算公式
     * @return
     */
    ...
    private static String handleNonStringCell(Cell cell, DataFormatter formatter)
    {
        ...
        if (type == Cell.CELL_TYPE_NUMERIC)
        {
            ...
            {
                return formatter.formatRawCellContents(cell.getNumericCellValue(), cs.getDataFormat(), cs
                        .getDataFormatString());
            }
        }
