...
public class TableConstants {
    ...
    public static final class C_EXTEND_INFO {
        ...
        public static final Column NONGZHUANG_ID = ColumnFactory.createColumn(TABLE, "NONGZHUANG_ID", DataType.LONG, true);
        public static final Column CUSTOMER = ColumnFactory.createColumn(TABLE, "CUSTOMER", DataType.STRING);
        public static final Column OFFICE = ColumnFactory.createColumn(TABLE, "OFFICE", DataType.STRING);
        public static final Column POSITION = ColumnFactory.createColumn(TABLE, "POSITION", DataType.STRING);
        public static final Column ID_NUMBER = ColumnFactory.createColumn(TABLE, "ID_NUMBER", DataType.STRING);
        public static final Column DETAIL_ADDRESS = ColumnFactory.createColumn(TABLE, "DETAIL_ADDRESS", DataType.STRING);
        public static final Column COMPLETE_ADDRESS = ColumnFactory.createColumn(TABLE, "COMPLETE_ADDRESS", DataType.STRING);
    }
    ...
    public static final class OFFICE {
        ...
        public static final Column AREA_ID = ColumnFactory.createColumn(TABLE, "AREA_ID", DataType.STRING);
        public static final Column DETAIL_ADDRESS = ColumnFactory.createColumn(TABLE, "DETAIL_ADDRESS", DataType.STRING);
        public static final Column COMPLETE_ADDRESS = ColumnFactory.createColumn(TABLE, "COMPLETE_ADDRESS", DataType.STRING);
        public static final Column IS_START = ColumnFactory.createColumn(TABLE, "IS_START", DataType.BOOLEAN);
    }
    ...
    public static final class OFFICE_RELATION {
        ...
        public static final Column OFFICE_ID = ColumnFactory.createColumn(TABLE, "OFFICE_ID", DataType.STRING, OFFICE.TABLE, Relation.N2One);
    ...
    public static final class RELATION {
        ...
        public static final Column YEAR = ColumnFactory.createColumn(TABLE, "YEAR", DataType.INT);
        public static final Column MONTH = ColumnFactory.createColumn(TABLE, "MONTH", DataType.INT);
    }
    ...
    public static final class ROLE {
        ...
        public static final Column ID = ColumnFactory.createColumn(TABLE, "ID", DataType.LONG, true);
        public static final Column NONGZHUANG_ID = ColumnFactory.createColumn(TABLE, "NONGZHUANG_ID", DataType.LONG, C_EXTEND_INFO.TABLE, Relation.N2One);
        public static final Column ROLE = ColumnFactory.createColumn(TABLE, "ROLE", DataType.STRING);
        public static final Column TYPE = ColumnFactory.createColumn(TABLE, "TYPE", DataType.STRING);
        public static final Column HIGHEST_ROLE = ColumnFactory.createColumn(TABLE, "HIGHEST_ROLE", DataType.STRING);
        public static final Column YEAR = ColumnFactory.createColumn(TABLE, "YEAR", DataType.STRING);
        public static final Column MONTH = ColumnFactory.createColumn(TABLE, "MONTH", DataType.STRING);
    }
    ...
    public static final class T_AREA {
        ...
        public static final Column AREA_NAME = ColumnFactory.createColumn(TABLE, "AREA_NAME", DataType.STRING);
    ...
    public static final class T_AWARD_ITEM {
        ...
        public static final Column AWARD_TYPE_NAME = ColumnFactory.createColumn(TABLE, "AWARD_TYPE_NAME", DataType.STRING);
        public static final Column AWARD_NUM = ColumnFactory.createColumn(TABLE, "AWARD_NUM", DataType.LONG);
        public static final Column AWARD_CONTENT = ColumnFactory.createColumn(TABLE, "AWARD_CONTENT", DataType.STRING);
    }
    ...
    public static final class T_AWARD_VIP {
        ...
        public static final Column AWARD_ID = ColumnFactory.createColumn(TABLE, "AWARD_ID", DataType.LONG, T_VIP_AWARD_MANAGE.TABLE, Relation.N2One);
        public static final Column SEND_STATUS = ColumnFactory.createColumn(TABLE, "SEND_STATUS", DataType.INT);
        public static final Column SEND_TYPE = ColumnFactory.createColumn(TABLE, "SEND_TYPE", DataType.INT);
    }
    ...
    public static final class T_DIY_FILTER {
        ...
        public static final Column ID = ColumnFactory.createColumn(TABLE, "ID", DataType.LONG, true);
        public static final Column FILTER_TYPE = ColumnFactory.createColumn(TABLE, "FILTER_TYPE", DataType.INT);
        public static final Column NAME = ColumnFactory.createColumn(TABLE, "NAME", DataType.STRING);
        public static final Column SORT = ColumnFactory.createColumn(TABLE, "SORT", DataType.INT);
    }
    ...
    public static final class T_DIY_FILTER_ITEM {
        ...
        public static final Column LOGIC_TYPE = ColumnFactory.createColumn(TABLE, "LOGIC_TYPE", DataType.INT);
        public static final Column NAME = ColumnFactory.createColumn(TABLE, "NAME", DataType.STRING);
        public static final Column OPERATOR = ColumnFactory.createColumn(TABLE, "OPERATOR", DataType.INT);
        public static final Column VALUE = ColumnFactory.createColumn(TABLE, "VALUE", DataType.STRING);
    }
    ...
    public static final class T_MSG_AUTO_SEND {
        ...
        public static final Column ID = ColumnFactory.createColumn(TABLE, "ID", DataType.LONG, true);
        public static final Column TYPE = ColumnFactory.createColumn(TABLE, "TYPE", DataType.INT);
        public static final Column NAME = ColumnFactory.createColumn(TABLE, "NAME", DataType.STRING);
        public static final Column SEND_DATE = ColumnFactory.createColumn(TABLE, "SEND_DATE", DataType.DATE);
        public static final Column TIME = ColumnFactory.createColumn(TABLE, "TIME", DataType.INT);
        public static final Column CONTENT = ColumnFactory.createColumn(TABLE, "CONTENT", DataType.STRING);
        public static final Column IS_OPEN = ColumnFactory.createColumn(TABLE, "IS_OPEN", DataType.BOOLEAN);
        public static final Column SEND_STATUS = ColumnFactory.createColumn(TABLE, "SEND_STATUS", DataType.INT);
        public static final Column SEND_TYPE = ColumnFactory.createColumn(TABLE, "SEND_TYPE", DataType.INT);
    }
    ...
    public static final class T_MSG_GROUP {
        ...
        public static final Column ID = ColumnFactory.createColumn(TABLE, "ID", DataType.LONG, true);
        public static final Column GROUP_NAME = ColumnFactory.createColumn(TABLE, "GROUP_NAME", DataType.STRING);
        public static final Column SORT = ColumnFactory.createColumn(TABLE, "SORT", DataType.INT);
    }
    ...
    public static final class T_PAYMENT_COLLECTION {
        ...
        public static final Column ID = ColumnFactory.createColumn(TABLE, "ID", DataType.LONG, true);
        public static final Column CUSTOM_ID = ColumnFactory.createColumn(TABLE, "CUSTOM_ID", DataType.LONG, T_VIP_PRIMARY_INFO.TABLE, Relation.N2One);
        public static final Column PROJECT_NAME = ColumnFactory.createColumn(TABLE, "PROJECT_NAME", DataType.STRING);
        public static final Column CAPITAL = ColumnFactory.createColumn(TABLE, "CAPITAL", DataType.INT);
        public static final Column PROFIT = ColumnFactory.createColumn(TABLE, "PROFIT", DataType.INT);
        public static final Column STATUS = ColumnFactory.createColumn(TABLE, "STATUS", DataType.INT);
        public static final Column PAYMENT_COLLECTION_DATE = ColumnFactory.createColumn(TABLE, "PAYMENT_COLLECTION_DATE", DataType.DATE);
        public static final Column PAYMENT_COLLECTION = ColumnFactory.createColumn(TABLE, "PAYMENT_COLLECTION", DataType.LONG);
    }
    ...
    public static final class T_PERMISSION {
        ...
        public static final Column NAME = ColumnFactory.createColumn(TABLE, "NAME", DataType.STRING);
        public static final Column IS_MENU = ColumnFactory.createColumn(TABLE, "IS_MENU", DataType.BOOLEAN);
        public static final Column URL = ColumnFactory.createColumn(TABLE, "URL", DataType.STRING);
        public static final Column CREATE_DATE = ColumnFactory.createColumn(TABLE, "CREATE_DATE", DataType.DATE);
        public static final Column MODIFY_DATE = ColumnFactory.createColumn(TABLE, "MODIFY_DATE", DataType.DATE);
        public static final Column SORT = ColumnFactory.createColumn(TABLE, "SORT", DataType.INT);
        public static final Column MARK = ColumnFactory.createColumn(TABLE, "MARK", DataType.STRING);
    }
    ...
    public static final class T_ROLE {
        ...
        public static final Column ID = ColumnFactory.createColumn(TABLE, "ID", DataType.LONG, true);
        public static final Column ROLE_NAME = ColumnFactory.createColumn(TABLE, "ROLE_NAME", DataType.STRING);
        public static final Column MARK = ColumnFactory.createColumn(TABLE, "MARK", DataType.STRING);
        public static final Column CREATE_DATE = ColumnFactory.createColumn(TABLE, "CREATE_DATE", DataType.DATE);
    ...
    public static final class T_SEND_HISTORY_VIP {
        ...
        public static final Column VIP_PHONE = ColumnFactory.createColumn(TABLE, "VIP_PHONE", DataType.STRING);
        public static final Column CUSTOM_ID = ColumnFactory.createColumn(TABLE, "CUSTOM_ID", DataType.LONG, T_VIP_PRIMARY_INFO.TABLE, Relation.N2One);
        public static final Column SEND_STATUS = ColumnFactory.createColumn(TABLE, "SEND_STATUS", DataType.INT);
    }
    ...
    public static final class T_SEPARATE_BILLS_APPLY {
        ...
        public static final Column APPLY_ID = ColumnFactory.createColumn(TABLE, "APPLY_ID", DataType.LONG, C_EXTEND_INFO.TABLE, Relation.N2One);
        public static final Column PHONE = ColumnFactory.createColumn(TABLE, "PHONE", DataType.STRING, true);
    ...
    public static final class T_USER {
        ...
        public static final Column ID = ColumnFactory.createColumn(TABLE, "ID", DataType.LONG, true);
        public static final Column LOGIN_NAME = ColumnFactory.createColumn(TABLE, "LOGIN_NAME", DataType.STRING);
        public static final Column PASSWORD = ColumnFactory.createColumn(TABLE, "PASSWORD", DataType.STRING);
        public static final Column CREATE_DATE = ColumnFactory.createColumn(TABLE, "CREATE_DATE", DataType.DATE);
        public static final Column CREATE_USER_ID = ColumnFactory.createColumn(TABLE, "CREATE_USER_ID", DataType.LONG, T_USER.TABLE, Relation.N2One);
        public static final Column ROLE_ID = ColumnFactory.createColumn(TABLE, "ROLE_ID", DataType.LONG, T_ROLE.TABLE, Relation.N2One);
        public static final Column MARK = ColumnFactory.createColumn(TABLE, "MARK", DataType.STRING);
    ...
    public static final class T_VIP_AWARD_MANAGE {
        ...
        public static final Column ID = ColumnFactory.createColumn(TABLE, "ID", DataType.LONG, true);
        public static final Column AWARD_NAME = ColumnFactory.createColumn(TABLE, "AWARD_NAME", DataType.STRING);
        public static final Column USER_ID = ColumnFactory.createColumn(TABLE, "USER_ID", DataType.LONG, T_USER.TABLE, Relation.N2One);
        public static final Column CREATING_TIME = ColumnFactory.createColumn(TABLE, "CREATING_TIME", DataType.DATE);
        public static final Column AWARD_DATE = ColumnFactory.createColumn(TABLE, "AWARD_DATE", DataType.DATE);
        public static final Column SEND_STATUS = ColumnFactory.createColumn(TABLE, "SEND_STATUS", DataType.INT);
        public static final Column SEND_TYPE = ColumnFactory.createColumn(TABLE, "SEND_TYPE", DataType.INT);
    }
    ...
    public static final class T_VIP_INVEST_FLOW {
        ...
        public static final Column INVEST_SOURCE = ColumnFactory.createColumn(TABLE, "INVEST_SOURCE", DataType.LONG);
        public static final Column EXPECTED_BACK_RATE = ColumnFactory.createColumn(TABLE, "EXPECTED_BACK_RATE", DataType.STRING);
        public static final Column INVESTOR_REG_DATE = ColumnFactory.createColumn(TABLE, "INVESTOR_REG_DATE", DataType.DATE);
        public static final Column INVEST_AMOUNT = ColumnFactory.createColumn(TABLE, "INVEST_AMOUNT", DataType.LONG);
        public static final Column INVEST_TERM = ColumnFactory.createColumn(TABLE, "INVEST_TERM", DataType.INT);
        public static final Column ANNUALIZED_INVEST = ColumnFactory.createColumn(TABLE, "ANNUALIZED_INVEST", DataType.STRING);
        public static final Column DISCOUNT_CODE = ColumnFactory.createColumn(TABLE, "DISCOUNT_CODE", DataType.STRING);
        public static final Column DISCOUNT_CUSTOM_ID = ColumnFactory.createColumn(TABLE, "DISCOUNT_CUSTOM_ID", DataType.LONG);
        public static final Column DISCOUNT_CUSTOM_NAME = ColumnFactory.createColumn(TABLE, "DISCOUNT_CUSTOM_NAME", DataType.STRING);
        public static final Column DISCOUNT_CUSTOM_CREATE_DATE = ColumnFactory.createColumn(TABLE, "DISCOUNT_CUSTOM_CREATE_DATE", DataType.DATE);
        public static final Column INVITATION_LEVEL = ColumnFactory.createColumn(TABLE, "INVITATION_LEVEL", DataType.LONG);
        public static final Column INVITATION_MONEY = ColumnFactory.createColumn(TABLE, "INVITATION_MONEY", DataType.STRING);
        public static final Column STANDER_TYPE = ColumnFactory.createColumn(TABLE, "STANDER_TYPE", DataType.STRING);
        public static final Column STANDER_STATUS = ColumnFactory.createColumn(TABLE, "STANDER_STATUS", DataType.STRING);
        public static final Column SETTLEMENT_STATUS = ColumnFactory.createColumn(TABLE, "SETTLEMENT_STATUS", DataType.LONG);
        public static final Column SETTLEMENT_DATE = ColumnFactory.createColumn(TABLE, "SETTLEMENT_DATE", DataType.DATE);
        public static final Column REPAYMENT_TYEP = ColumnFactory.createColumn(TABLE, "REPAYMENT_TYEP", DataType.STRING);
        public static final Column DISCOUNT_PERSON_INVITATION_ID = ColumnFactory.createColumn(TABLE, "DISCOUNT_PERSON_INVITATION_ID", DataType.LONG);
        public static final Column DISCOUNT_PERSON_INVITATION_NAME = ColumnFactory.createColumn(TABLE, "DISCOUNT_PERSON_INVITATION_NAME", DataType.STRING);
        public static final Column DISCOUNT_PERSON_INVITATION_GROUP = ColumnFactory.createColumn(TABLE, "DISCOUNT_PERSON_INVITATION_GROUP", DataType.STRING);
        public static final Column STANDER_TAG = ColumnFactory.createColumn(TABLE, "STANDER_TAG", DataType.STRING);
        public static final Column INVEST_INVITATION = ColumnFactory.createColumn(TABLE, "INVEST_INVITATION", DataType.STRING);
        public static final Column INVEST_DATE = ColumnFactory.createColumn(TABLE, "INVEST_DATE", DataType.DATE);
    }
    ...
    public static final class T_VIP_INVEST_INFO {
        ...
        public static final Column RANK = ColumnFactory.createColumn(TABLE, "RANK", DataType.INT);
        ...
        public static final Column RANK_ACC = ColumnFactory.createColumn(TABLE, "RANK_ACC", DataType.INT);
    }
    ...
    public static final class T_VIP_MARKETING_RECORD {
        ...
        public static final Column ID = ColumnFactory.createColumn(TABLE, "ID", DataType.LONG, true);
        public static final Column CUSTOM_ID = ColumnFactory.createColumn(TABLE, "CUSTOM_ID", DataType.LONG, T_VIP_PRIMARY_INFO.TABLE, Relation.N2One);
        public static final Column FOLLOWING_STAGE = ColumnFactory.createColumn(TABLE, "FOLLOWING_STAGE", DataType.INT);
        public static final Column CONTENTS = ColumnFactory.createColumn(TABLE, "CONTENTS", DataType.STRING);
        public static final Column USER_ID = ColumnFactory.createColumn(TABLE, "USER_ID", DataType.LONG, T_USER.TABLE, Relation.N2One);
        public static final Column EDITOR_ID = ColumnFactory.createColumn(TABLE, "EDITOR_ID", DataType.LONG);
        public static final Column CREATE_DATE = ColumnFactory.createColumn(TABLE, "CREATE_DATE", DataType.DATE);
        public static final Column EDIT_DATE = ColumnFactory.createColumn(TABLE, "EDIT_DATE", DataType.DATE);
        public static final Column FOLLOWING_DATE = ColumnFactory.createColumn(TABLE, "FOLLOWING_DATE", DataType.DATE);
    }
    ...
    public static final class T_VIP_MSG_SENDING_HISTORY {
        ...
        public static final Column ID = ColumnFactory.createColumn(TABLE, "ID", DataType.LONG, true);
        public static final Column MSG_ID = ColumnFactory.createColumn(TABLE, "MSG_ID", DataType.LONG, T_MSG_AUTO_SEND.TABLE, Relation.N2One);
        public static final Column MSG_NAME = ColumnFactory.createColumn(TABLE, "MSG_NAME", DataType.STRING);
        public static final Column SEND_DATE = ColumnFactory.createColumn(TABLE, "SEND_DATE", DataType.DATE);
        public static final Column SEND_CONTENT = ColumnFactory.createColumn(TABLE, "SEND_CONTENT", DataType.STRING);
    }

    public static final class T_VIP_PRIMARY_INFO {
        public static final Table TABLE = new Table(18, "T_VIP_PRIMARY_INFO", CacheType.NOT_CACHE, "com/hhnz/api/cfcrm/model.cfcrm.VipPrimaryInfo");

        public static final Column ID = ColumnFactory.createColumn(TABLE, "ID", DataType.LONG, true);
        public static final Column NONGZHUANG_ID = ColumnFactory.createColumn(TABLE, "NONGZHUANG_ID", DataType.LONG);
        public static final Column NAME = ColumnFactory.createColumn(TABLE, "NAME", DataType.STRING, false, true);
        ...
        public static final Column BIRTHDAY = ColumnFactory.createColumn(TABLE, "BIRTHDAY", DataType.DATE);
        public static final Column MONTH = ColumnFactory.createColumn(TABLE, "MONTH", DataType.INT);
        public static final Column DAY = ColumnFactory.createColumn(TABLE, "DAY", DataType.INT);
        ...
        public static final Column DETAIL_ADDRESS = ColumnFactory.createColumn(TABLE, "DETAIL_ADDRESS", DataType.STRING);
        public static final Column IS_DEL = ColumnFactory.createColumn(TABLE, "IS_DEL", DataType.BOOLEAN);
        public static final Column CUSTOM_TYPE = ColumnFactory.createColumn(TABLE, "CUSTOM_TYPE", DataType.INT, false, true, "CustomType");
        public static final Column OFFICE_TYPE = ColumnFactory.createColumn(TABLE, "OFFICE_TYPE", DataType.INT);
        public static final Column BE_VIP = ColumnFactory.createColumn(TABLE, "BE_VIP", DataType.BOOLEAN);
        public static final Column VIP_START = ColumnFactory.createColumn(TABLE, "VIP_START", DataType.DATE);
    }
    ...
    public static final class USERS_BAN {
        ...
        public static final Column YEAR = ColumnFactory.createColumn(TABLE, "YEAR", DataType.INT);
        public static final Column MONTH = ColumnFactory.createColumn(TABLE, "MONTH", DataType.INT);
        public static final Column SALT = ColumnFactory.createColumn(TABLE, "SALT", DataType.BOOLEAN);
    }
